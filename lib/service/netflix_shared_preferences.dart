...
class NetflixSharedPreferences {
  static const myMoviesListKey = "my_movie_lists_key";

  NetflixSharedPreferences() {
  ...
  Future<void> addMovie(MovieGeneral movie) async {
    await _initSharedPreferences();
  ...
  List<MovieGeneral> _convertJsonToMovieLists(String movieJson) {
    return (json.decode(movieJson) as List<dynamic>).map((movieJson) => MovieGeneral.fromJson(movieJson as Map<String, dynamic>)).toList();
  }
}
